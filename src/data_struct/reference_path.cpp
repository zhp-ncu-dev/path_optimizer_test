...
void ReferencePath::clear() { reference_path_impl_->clear(); }
...
void ReferencePath::setLength(double s) { reference_path_impl_->setLength(s); }
...
ReferencePath::display_abnormal_bounds() const {
  return reference_path_impl_->display_abnormal_bounds();
}

void ReferencePath::setReference(
...
void ReferencePath::updateLimits() { reference_path_impl_->updateLimits(); }

bool ReferencePath::buildReferenceFromSpline(double delta_s_smaller,
                                             double delta_s_larger) {
  reference_path_impl_->buildReferenceFromSpline(delta_s_smaller,
                                                 delta_s_larger);
}
